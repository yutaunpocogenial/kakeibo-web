...
class IncomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create income" do
    assert_difference('Income.count') do
      post incomes_url, params: { income: { income: @income.income, name: @income.name, user_id: @income.user_id } }
    end
  ...
  test "should update income" do
    patch income_url(@income), params: { income: { income: @income.income, name: @income.name, user_id: @income.user_id } }
